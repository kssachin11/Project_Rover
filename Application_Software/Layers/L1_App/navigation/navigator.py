from Layers.L1_App.navigation.a_star import AStar
from Layers.L1_App.navigation.map import Map
from Layers.L1_App.navigation.metric_position import MetricPosition
from Layers.L1_App.navigation.point_cloud_cartesian import PointCloudCartesian
from Layers.L1_App.navigation.polar import Polar


class Navigator():
    def __init__(self, point_cloud_polar: list[any([Polar, list])], position_map: Map, path_map: Map, target: MetricPosition, stages: int = 4, threshold: float = 0.7) -> None:
        """_summary_
